...
from lnmpm.app import create_app
from lnmpm.database import db
from lnmpm.hosts.models import Hosts
from lnmpm.settings import DevConfig, ProdConfig
from lnmpm.user.models import User

CONFIG = ProdConfig if os.environ.get('LNMPM_ENV') == 'prod' else DevConfig
...
def _make_context():
    ...
    return {'app': app, 'db': db, 'User': User, 'Hosts': Hosts}
